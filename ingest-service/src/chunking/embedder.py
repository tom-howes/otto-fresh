...
class ChunkEmbedder:
    ...
    def initialize_model(self) -> bool:
        ...
        try:
            ...
            print(
                f"  Batch size: {self.batch_size} (250x faster than one-by-one)")
            return True
    ...
    def embed_repository(self, repo_path: str,
        ...
        if force_reembed:
            ...
            print(
                f"🔄 Force re-embed: cleared embeddings from {len(chunks)} chunks")
        ...
        print(
            f"Time: {elapsed:.1f}s ({len(chunks_to_embed) / elapsed:.1f} chunks/sec)")
        ...
        for i in range(0, len(chunks), self.batch_size):
            ...
            try:
                ...
                print(
                    ...
                    f"{success_count}/{len(chunks)} total "
                ...
                error_msg = str(e)[:100]
                print(
                    f"  ❌ Batch {i // self.batch_size + 1} failed: {error_msg}")
    ...
    def _save_chunks(self, repo_path: str, chunks: List[Dict]):
        ...
        print(
            f"💾 Saved to: gs://{self.bucket_processed}/{repo_path}/chunks.jsonl")
